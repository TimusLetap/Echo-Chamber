document.addEventListener('DOMContentLoaded', () => {
    ...
    function startSession() {
        ...
        const opener = `The data streams are open for our reflection. It's a ${dayString.toLowerCase()} ${timeString}. Please, share a thought to start our story.`;
    ...
    async function getAIResponse() {
        ...
        const apiKey = "AIzaSyBFdZQwQlMD0j1P6nXN2J4HjpgHRUpHF3w"; // PASTE YOUR GEMINI API KEY HERE
        if (!apiKey) {
